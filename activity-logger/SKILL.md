...
- `/Users/alecmandla/Documents/Metolius/CLAUDE.md` — picked up by Cowork sessions rooted in Metolius
...
2026-03-04 15:45 | claude-code | Debugging BigQuery pipeline for Lightspeed inventory sync | Lightspeed DMS | bigquery,lightspeed,inventory-sync,etl
...
```
/Users/alecmandla/Documents/Metolius/Cowork_Skills/update_timesheet/timely-timesheet-logger/data/activity-log.txt
```
...
**Good**: `looker-automation`, `lightspeed-dms`, `PROJ-1234`, `feature/universal-linking`, `acme-redesign.figma`
