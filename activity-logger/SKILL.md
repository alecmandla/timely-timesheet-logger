...
| `summary` | Yes | 1-2 sentence description of what was done. Be specific: "Wrote SQL migration for Lightspeed DMS inventory sync" not "Worked on database stuff." |
...
**Good**: `looker-automation`, `lightspeed-inventory`, `bigquery-sync`, `PROJ-1234`, `feature/universal-linking`, `acme-redesign.figma`
...
- **Explicit mentions**: "Let's work on the Lightspeed project" → High confidence
- **File paths**: `/repos/lightspeed-dms/` → High confidence
